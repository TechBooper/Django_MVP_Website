...
def edit_ticket(request, ticket_id):
    return handle_edit_form(request, ticket_id, Ticket, TicketForm, 'edit_ticket.html', 'Ticket updated successfully.')

@login_required
@require_POST
def delete_ticket(request, ticket_id):
    return handle_delete(request, ticket_id, Ticket, 'Ticket deleted successfully.')
...
def edit_review(request, review_id):
    return handle_edit_form(request, review_id, Review, ReviewForm, 'edit_review.html', 'Review updated successfully.')

@login_required
@require_POST
def delete_review(request, review_id):
    return handle_delete(request, review_id, Review, 'Review deleted successfully.')
